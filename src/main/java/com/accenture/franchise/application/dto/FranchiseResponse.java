...
public record FranchiseResponse(
    @Schema(description = "ID único de la franquicia", example = "123e4567-e89b-12d3-a456-426614174001")
    UUID id,
    
    @Schema(description = "Nombre de la franquicia", example = "Franquicia ABC")
    String name,
