...
public record BranchResponse(
    @Schema(
        ...
        UUID id,
    @Schema(description = "Nombre de la sucursal", example = "Sucursal Centro") String name,
    @Schema(
            description = "ID de la franquicia a la que pertenece",
            example = "123e4567-e89b-12d3-a456-426614174001")
        UUID franchiseId,
    @Schema(description = "Lista de productos de la sucursal") List<ProductResponse> products) {}
